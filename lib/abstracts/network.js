module.exports = class Network {
   ...
   * @return {*} See the reutrn statement of the get function of the view
   */
  getView (...args) {
    return this._manager.view.get(this.name, ...args)
  }
   ...
   */
  mergeView (...args) {
    this._manager.view.merge(this.name, ...args)
  }
  ...
  async addNeighbour (peer) {
    ...
    await this.mergeView(lock, [peer])
  }
}

const NetworkView = require('../views/network-view.js')
...
module.exports = class Network {
  constructor (name, options) {
    ...
    this._view = new NetworkView(options, this.options.get(name + '-view'))
  ...
  async addNeighbour (peer) {
    const { lock } = this.view.get()
    this.view.merge(lock, [peer])
  }
}

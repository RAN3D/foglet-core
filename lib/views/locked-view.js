...
module.exports = class LockedView extends View {
   ...
   * Please dont use this method for managing views...
   * @return {Map} Map of the identifier storing networks identifier and number of occurences for all neighbours of all networks
   */
  get view () {
    return this._view
  }
